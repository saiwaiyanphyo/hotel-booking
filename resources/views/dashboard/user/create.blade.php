    ...
    <div class="widget box box-shadow layout-top-spacing">
        ...
        <div class="widget-content widget-content-area">
            ...
            <div class="dashboard-form">
                <div class="row gx-5">
                    <div class="col-md-12">
                        <form class="row g-4" action="{{ route('admin.users.store') }}"
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <x-text-input name="name" :value="old('name')" label="Name"
                                                      :error="$errors->first('name')" :required="true"/>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <x-email-input name="email" :value="old('email')" label="Email"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <x-text-input name="position" :value="old('position')" label="Position"
