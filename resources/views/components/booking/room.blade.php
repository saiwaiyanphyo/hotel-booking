    ...
    <div class="row mb-2">
        <div class="col-md-6">
            <div class="form-floating">
                <select class="form-select @error('rooms.0.room_id') is-invalid @enderror" id="roomId0"
                    name="rooms[0][room_id]" aria-label="room_id">
        ...
        <div class="col-2">
            <button type="button" class="btn btn-success light float-end" id="addMoreRoom">Add More
            </button>
        </div>
    </div>
</div>